...
public class ItemSearch {
    ...
    private static final String AWS_ACCESS_KEY_ID = "AKIAIYQNVUS6VP5E7IPQ";
    ...
    private static final String AWS_SECRET_KEY = "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";
    ...
    public static void main(String[] args) {
        ...
        title = printResponse(requestUrl);
...
//        title = printResponse(requestUrl);
   ...
   private static String printResponse(String requestUrl) {
